...
public class Inven : MonoBehaviour
{
    ...
    private List<ShopItem> m_lItems = new List<ShopItem>();
...

    {
        ...
        m_lItemNames.Add("red_armour");

        m_lItemNames.Add("blue_armour");

        m_lItemNames.Add("white_armour");

        m_lItemNames.Add("black_armour");

        m_lItemNames.Add("red화살");

        m_lItemNames.Add("blue화살");

        m_lItemNames.Add("white화살");

        m_lItemNames.Add("black화살");

        m_lItemNames.Add("fire");

        m_lItemNames.Add("water");

        m_lItemNames.Add("light");

        m_lItemNames.Add("dark");
...

    {
        ...
        ShopItem shopItem = gObjItem.GetComponent<ShopItem>();

        shopItem.SetInfo(m_lItemNames[nRandomIndex]);
